...
def plot_model_predict(model, cochains, angles, times, test_stop_idx):
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/model_approx" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/model_approx_first_minute" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/errorplot" + ".pdf"))
	# plt.show()
	plt.close()


	MAE_file = open(os.path.join(sys.path[0], "extracted/trainMAE" + ".txt"), "w")
	MAE_file.write(str(train_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/trainAAE" + ".txt"), "w")
	AAE_file.write(str(train_AAE))
	AAE_file.close()

	MAE_file = open(os.path.join(sys.path[0], "extracted/testMAE" + ".txt"), "w")
	MAE_file.write(str(test_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/testAAE" + ".txt"), "w")
...
def plot_model_predictSCRNN(model, seq_length, cochains, angles, times, test_stop_idx):
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/SCRNNmodel_approx" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/SCRNNmodel_approx_first_minute" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/SCRNNerrorplot" + ".pdf"))
	# plt.show()
	plt.close()


	MAE_file = open(os.path.join(sys.path[0], "extracted/SCRNNtrainMAE" + ".txt"), "w")
	MAE_file.write(str(train_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/SCRNNtrainAAE" + ".txt"), "w")
	AAE_file.write(str(train_AAE))
	AAE_file.close()

	MAE_file = open(os.path.join(sys.path[0], "extracted/SCRNNtestMAE" + ".txt"), "w")
	MAE_file.write(str(test_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/SCRNNtestAAE" + ".txt"), "w")
	AAE_file.write(str(test_AAE))
	AAE_file.close()
...
def plot_model_predictFFNN(model, spike_count_matrix, angles, times, test_stop_idx):
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/FFNNmodel_approx" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/FFNNmodel_approx_first_minute" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/FFNNerrorplot" + ".pdf"))
	# plt.show()
	plt.close()
...
def plot_model_predictRNN(model, seq_length, spike_count_matrix, angles, times, test_stop_idx):
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/RNNmodel_approx" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/RNNmodel_approx_first_minute" + ".pdf"))
	# plt.show()
	plt.close()
	...
	plt.margins(0,0)
	plt.savefig(os.path.join(sys.path[0], "plots/RNNerrorplot" + ".pdf"))
	# plt.show()
	plt.close()


	MAE_file = open(os.path.join(sys.path[0], "extracted/RNNtrainMAE" + ".txt"), "w")
	MAE_file.write(str(train_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/RNNtrainAAE" + ".txt"), "w")
	AAE_file.write(str(train_AAE))
	AAE_file.close()

	MAE_file = open(os.path.join(sys.path[0], "extracted/RNNtestMAE" + ".txt"), "w")
	MAE_file.write(str(test_MAE))
	MAE_file.close()

	AAE_file = open(os.path.join(sys.path[0], "extracted/RNNtestAAE" + ".txt"), "w")
	AAE_file.write(str(test_AAE))
	AAE_file.close()
